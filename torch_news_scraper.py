...
def scrape_all_links(url):
    try:
        ...
        for a_tag in soup.find_all('a', href=True):
            ...
            # Normalize: if href is 'news/...' make it '/news/...'
            if href.startswith('news/') and not href.startswith('/news/'):
                href = '/' + href
...
base_url = "https://torchtechnologies.com/news/"
all_links = set()
...
print("✅ Done. All articles saved to news_data.txt")
