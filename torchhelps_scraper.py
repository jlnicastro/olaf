...
def scrape_all_links(url):
    try:
        ...
        for a_tag in header_tag.find_all('a', href=True):
            href = a_tag['href']
            ...
            if 'https://torchhelps.org/' in absolute_url:
...
with open("torchhelps_data.txt", "w", encoding="utf-8") as f:
    f.write(all_text)